...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=800&color=00FF41&center=true&vCenter=true&width=600&lines=Ol%C3%A1%2C+Sou+LuizWhoami;Hacker+em+Desenvolvimento;Mr.+Robot+Style;Matrix+Reality;Python+%2B+Django+%2B+Flutter" alt="Typing SVG" />
</div>
...
LuizWhoami
Dev | Hacker | Matrix Explorer
Localização: [Brasil]
Kernel: Python / Django / Flutter
Shell: zsh (com esteroides)
...
Comandos disponíveis:
  ...
  - projects        → Abre o portfólio
  - connect         → Mostra redes sociais
  - matrix          → Inicializa o modo Matrix (efeito visual)
  - exit            → Sai do terminal
🧬 DNA Hacker
🔭 Atualmente trabalhando em projetos com Django e Flutter

🌱 Aprendendo Rust e Kubernetes

👯 Buscando colaborar em projetos open-source com impacto social

💬 Pergunte-me sobre Python, automação e segurança ofensiva

⚡ Curiosidade: Já decodifiquei mensagens em binário só por diversão 😎

<div align="center"> <img src="https://komarev.com/ghpvc/?username=luizwhoami&label=VISITAS&color=00FF41&style=flat-square" alt="Visitor Count" /> <br><br> <img src="https://capsule-render.vercel.app/api?type=waving&color=00FF41&height=100&section=footer&text=Matrix%20Loading...&fontSize=40&fontColor=0D1117&animation=twinkling" /> </div> ```
